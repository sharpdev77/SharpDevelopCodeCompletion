...
namespace ICSharpCode.NRefactory.PrettyPrinter
{
    public sealed class CSharpOutputVisitor : NodeTrackingAstVisitor, IOutputAstVisitor
    {
        ...
        private readonly CSharpOutputFormatter outputFormatter;
        ...
        public string Text
        {
            get { return outputFormatter.Text; }
        }
        ...
        public override object TrackedVisitQueryExpressionGroupClause(QueryExpressionGroupClause groupClause,
                                                                      object data)
        {
        ...
        public override object TrackedVisitQueryExpressionOrderClause(
            QueryExpressionOrderClause queryExpressionOrderClause, object data)
        {
        ...
        public override object TrackedVisitQueryExpressionSelectClause(QueryExpressionSelectClause selectClause,
                                                                       object data)
        {
        ...
        public override object TrackedVisitQueryExpressionWhereClause(QueryExpressionWhereClause whereClause,
                                                                      object data)
        {
        ...
        public override object TrackedVisitInnerClassTypeReference(InnerClassTypeReference innerClassTypeReference,
                                                                   object data)
        {
        ...
        public override object TrackedVisitNamedArgumentExpression(NamedArgumentExpression namedArgumentExpression,
                                                                   object data)
        {
        ...
        public override object TrackedVisitTypeDeclaration(TypeDeclaration typeDeclaration, object data)
        {
            ...
            switch (typeDeclaration.Type)
            {
                case ClassType.Enum:
                    ...
                    break;
                case ClassType.Interface:
                    outputFormatter.BeginBrace(prettyPrintOptions.InterfaceBraceStyle,
                                               prettyPrintOptions.IndentInterfaceBody);
                    break;
                case ClassType.Struct:
        ...
        public override object TrackedVisitDelegateDeclaration(DelegateDeclaration delegateDeclaration, object data)
        {
            ...
            outputFormatter.PrintToken(Tokens.OpenParenthesis);
            bool withinParentheses = prettyPrintOptions.WithinMethodDeclarationParentheses &&
                                     delegateDeclaration.Parameters.Any();
        ...
        {
            if (((optionDeclaration.OptionType == OptionType.Explicit ||
                  optionDeclaration.OptionType == OptionType.Strict)
        ...
        {
            BraceStyle braceStyle = prettyPrintOptions.PropertyBraceStyle;

            if (getRegion.Block.IsNull && setRegion.Block.IsNull && getRegion.Attributes.Count == 0 &&
                setRegion.Attributes.Count == 0)
            {
                outputFormatter.Space();
            ...
            {
                outputFormatter.BeginBrace(braceStyle, prettyPrintOptions.IndentPropertyBody);
        ...
        public override object TrackedVisitEventDeclaration(EventDeclaration eventDeclaration, object data)
        {
            ...
            {
                outputFormatter.BeginBrace(prettyPrintOptions.EventBraceStyle, prettyPrintOptions.IndentEventBody);
        ...
        public override object TrackedVisitParameterDeclarationExpression(
            ParameterDeclarationExpression parameterDeclarationExpression, object data)
        {
        ...
        private void PrintMethodDeclaration(MethodDeclaration methodDeclaration)
        {
            ...
            outputFormatter.PrintToken(Tokens.OpenParenthesis);
            bool withinParentheses = prettyPrintOptions.WithinMethodDeclarationParentheses &&
                                     methodDeclaration.Parameters.Any();
            if (withinParentheses)
            {
                outputFormatter.Space();
            }
            ...
            else
            {
                switch (operatorDeclaration.OverloadableOperator)
                {
                    ...
                    case OverloadableOperatorType.Subtract:
                        ...
                        break;
                    default:
                        Error(operatorDeclaration,
                              operatorDeclaration.OverloadableOperator.ToString() +
                              " is not supported as overloadable operator");
                        break;
                }
            }
        ...
        public override object TrackedVisitInterfaceImplementation(InterfaceImplementation interfaceImplementation,
                                                                   object data)
        {
            throw new InvalidOperationException();
        }

        public override object TrackedVisitConstructorDeclaration(ConstructorDeclaration constructorDeclaration,
                                                                  object data)
        {
            ...
            outputFormatter.PrintToken(Tokens.OpenParenthesis);
            bool withinParentheses = prettyPrintOptions.WithinMethodDeclarationParentheses &&
                                     constructorDeclaration.Parameters.Any();
            if (withinParentheses)
            {
                outputFormatter.Space();
            }
        ...
        public override object TrackedVisitConstructorInitializer(ConstructorInitializer constructorInitializer,
                                                                  object data)
        {
        ...
        public override object TrackedVisitDestructorDeclaration(DestructorDeclaration destructorDeclaration,
                                                                 object data)
        {
        ...
        private void OutputBlock(BlockStatement blockStatement, BraceStyle braceStyle, bool emitEndingNewLine)
        {
            ...
            else
            {
                ...
                foreach (Statement stmt in blockStatement.Children)
                {
                    ...
                    if (!outputFormatter.OnlyWhitespacesOrTabsAfterLastNewLine)
                        outputFormatter.NewLine();
                }
        ...
        public override object TrackedVisitRemoveHandlerStatement(RemoveHandlerStatement removeHandlerStatement,
                                                                  object data)
        {
        ...
        public override object TrackedVisitLocalVariableDeclaration(LocalVariableDeclaration localVariableDeclaration,
                                                                    object data)
        {
        ...
        private object TrackedVisitLocalVariableDeclarationSeparateTypes(
            LocalVariableDeclaration localVariableDeclaration, object data)
        {
            for (int i = 0; i < localVariableDeclaration.Variables.Count; ++i)
            {
                ...
                OutputModifier(localVariableDeclaration.Modifier);
                TrackVisit(localVariableDeclaration.GetTypeForVariable(i) ?? new TypeReference("System.Object", true),
                           data);
                outputFormatter.Space();
                TrackVisit(v, data);
                outputFormatter.PrintToken(Tokens.Semicolon);
        ...
        public override object TrackedVisitIfElseStatement(IfElseStatement ifElseStatement, object data)
        {
            ...
            if (ifElseStatement.HasElseStatements)
            {
                if (prettyPrintOptions.PlaceElseOnNewLine ||
                    (prettyPrintOptions.PlaceNonBlockElseOnNewLine && !wasBlock))
                {
                    if (!outputFormatter.LastCharacterIsNewLine)
                        outputFormatter.NewLine();
                    outputFormatter.Indent();
        ...
        public override object TrackedVisitElseIfSection(ElseIfSection elseIfSection, object data)
        {
            ...
            WriteEmbeddedStatement(elseIfSection.EmbeddedStatement, prettyPrintOptions.IfElseBraceForcement,
                                   prettyPrintOptions.StatementBraceStyle, false);
        ...
        public override object TrackedVisitForStatement(ForStatement forStatement, object data)
        {
            ...
            WriteEmbeddedStatement(forStatement.EmbeddedStatement, prettyPrintOptions.ForBraceForcement,
                                   prettyPrintOptions.StatementBraceStyle, true);
        ...
        private void WriteEmbeddedStatement(Statement statement, BraceForcement forcement, BraceStyle braceStyle,
                                            bool emitEndingNewLine)
        {
            if (statement is BlockStatement)
            {
                ...
                switch (forcement)
                {
                    ...
                    default:
                        OutputBlock((BlockStatement) statement, prettyPrintOptions.StatementBraceStyle,
                                    emitEndingNewLine);
                        break;
                }
            }
        ...
        public override object TrackedVisitCaseLabel(CaseLabel caseLabel, object data)
        {
            ...
            else
            {
                ...
                {
                    Error(caseLabel,
                          String.Format("Case labels with binary operators are unsupported : {0}",
                                        caseLabel.BinaryOperatorType));
                }
        ...
        public override object TrackedVisitDoLoopStatement(DoLoopStatement doLoopStatement, object data)
        {
            ...
            WriteEmbeddedStatement(doLoopStatement.EmbeddedStatement, prettyPrintOptions.WhileBraceForcement,
                                   prettyPrintOptions.StatementBraceStyle, prettyPrintOptions.PlaceWhileOnNewLine);
        ...
        public override object TrackedVisitForeachStatement(ForeachStatement foreachStatement, object data)
        {
            ...
            WriteEmbeddedStatement(foreachStatement.EmbeddedStatement, prettyPrintOptions.ForEachBraceForcement,
                                   prettyPrintOptions.StatementBraceStyle, true);
        ...
        public override object TrackedVisitUsingStatement(UsingStatement usingStatement, object data)
        {
            ...
            WriteEmbeddedStatement(usingStatement.EmbeddedStatement, prettyPrintOptions.UsingBraceForcement,
                                   prettyPrintOptions.StatementBraceStyle, true);
        ...
        public override object TrackedVisitCatchClause(CatchClause catchClause, object data)
        {
            ...
            WriteEmbeddedStatement(catchClause.StatementBlock,
                                   ((bool) data)
                                       ...
                                       : prettyPrintOptions.PlaceCatchOnNewLine);
            return null;
        }
        ...
        public override object TrackedVisitFixedStatement(FixedStatement fixedStatement, object data)
        {
            ...
            WriteEmbeddedStatement(fixedStatement.EmbeddedStatement, prettyPrintOptions.FixedBraceForcement,
                                   prettyPrintOptions.StatementBraceStyle, true);
            return null;
        }
        ...
        {
            if (exitStatement.ExitType == ExitType.Function || exitStatement.ExitType == ExitType.Sub ||
                exitStatement.ExitType == ExitType.Property)
            {
                outputFormatter.PrintToken(Tokens.Return);
                outputFormatter.PrintToken(Tokens.Semicolon);
            }
        ...
        public override object TrackedVisitForNextStatement(ForNextStatement forNextStatement, object data)
        {
            ...
            {
                if (stepExpr is UnaryOperatorExpression &&
                    ((UnaryOperatorExpression) stepExpr).Op == UnaryOperatorType.Plus)
                    outputFormatter.PrintToken(Tokens.LessEqual);
                else
                    outputFormatter.PrintToken(Tokens.GreaterEqual);
            }
            ...
            WriteEmbeddedStatement(forNextStatement.EmbeddedStatement, prettyPrintOptions.ForBraceForcement,
                                   prettyPrintOptions.StatementBraceStyle, true);
            return null;
        }
        ...
        public override object TrackedVisitClassReferenceExpression(ClassReferenceExpression classReferenceExpression,
                                                                    object data)
        {
        ...
        public override object TrackedVisitBinaryOperatorExpression(BinaryOperatorExpression binaryOperatorExpression,
                                                                    object data)
        {
            ...
            switch (binaryOperatorExpression.Op)
            {
                ...
                default:
                    Error(binaryOperatorExpression,
                          String.Format("Unknown binary operator {0}", binaryOperatorExpression.Op));
                    return null;
            }
            TrackVisit(binaryOperatorExpression.Right, data);
            return null;
        ...
        public override object TrackedVisitParenthesizedExpression(ParenthesizedExpression parenthesizedExpression,
                                                                   object data)
        {
            outputFormatter.PrintToken(Tokens.OpenParenthesis);
        ...
        public override object TrackedVisitTypeReferenceExpression(TypeReferenceExpression typeReferenceExpression,
                                                                   object data)
        {
        ...
        public override object TrackedVisitUnaryOperatorExpression(UnaryOperatorExpression unaryOperatorExpression,
                                                                   object data)
        {
            switch (unaryOperatorExpression.Op)
            {
                ...
                case UnaryOperatorType.Await:
                    ...
                    break;
                default:
                    Error(unaryOperatorExpression,
                          String.Format("Unknown unary operator {0}", unaryOperatorExpression.Op));
                    return null;
            }
            TrackVisit(unaryOperatorExpression.Expression, data);
            return null;
            ...
            switch (assignmentExpression.Op)
            {
                ...
                default:
                    Error(assignmentExpression,
                          String.Format("Unknown assignment operator {0}", assignmentExpression.Op));
                    return null;
            }
            if (prettyPrintOptions.AroundAssignmentParentheses)
            {
        ...
        public override object TrackedVisitDefaultValueExpression(DefaultValueExpression defaultValueExpression,
                                                                  object data)
        {
            outputFormatter.PrintToken(Tokens.Default);
            if (prettyPrintOptions.TypeOfParentheses)
        ...
        public override object TrackedVisitAnonymousMethodExpression(
            AnonymousMethodExpression anonymousMethodExpression, object data)
        {
            ...
            OutputBlockAllowInline(anonymousMethodExpression.Body, prettyPrintOptions.AnonymousMethodBraceStyle, false);
            return null;
        }
        ...
        public override object TrackedVisitLambdaExpression(LambdaExpression lambdaExpression, object data)
        {
            ...
            {
                OutputBlockAllowInline(lambdaExpression.StatementBody as BlockStatement,
                                       prettyPrintOptions.MethodBraceStyle, false);
            }
            return null;
        }
        ...
        public override object TrackedVisitPointerReferenceExpression(
        ...
        public override object TrackedVisitThisReferenceExpression(ThisReferenceExpression thisReferenceExpression,
                                                                   object data)
        {
            outputFormatter.PrintToken(Tokens.This);
            return null;
        ...
        public override object TrackedVisitBaseReferenceExpression(BaseReferenceExpression baseReferenceExpression,
                                                                   object data)
        {
            outputFormatter.PrintToken(Tokens.Base);
            return null;
        ...
        public override object TrackedVisitObjectCreateExpression(ObjectCreateExpression objectCreateExpression,
                                                                  object data)
        {
            outputFormatter.PrintToken(Tokens.New);
        ...
        public override object TrackedVisitArrayCreateExpression(ArrayCreateExpression arrayCreateExpression,
                                                                 object data)
        {
            outputFormatter.PrintToken(Tokens.New);
            ...
            else
            {
                ...
                {
                    outputFormatter.PrintToken(Tokens.OpenSquareBracket);
                    bool outputSpace = prettyPrintOptions.SpacesWithinBrackets &&
                                       arrayCreateExpression.Arguments.Count > 0;
                    if (outputSpace)
                    {
                        outputFormatter.Space();
                    }
        ...
        public override object TrackedVisitMemberInitializerExpression(
        ...
        public override object TrackedVisitMemberReferenceExpression(
        ...
        public override object TrackedVisitCollectionInitializerExpression(
            CollectionInitializerExpression arrayInitializerExpression, object data)
        {
            if (!outputFormatter.OnlyWhitespacesOrTabsAfterLastNewLine)
            {
                outputFormatter.NewLine();
        ...
        public override object TrackedVisitConditionalExpression(ConditionalExpression conditionalExpression,
                                                                 object data)
        {
