...
namespace ICSharpCode.AvalonEdit.CodeCompletion
{
    public static class DocumentUtilitites
    {
        ...
        {
            return TextUtilities.GetNextCaretPosition(GetTextSource(textBuffer), offset, LogicalDirection.Backward,
        ...
        {
            return TextUtilities.GetNextCaretPosition(GetTextSource(textBuffer), offset, LogicalDirection.Forward,
                                                      CaretPositioningMode.WordStart);
        }
        ...
        public static ITextSource GetTextSource(ITextBuffer textBuffer)
        {
            if (textBuffer == null)
        ...
        private sealed class TextBufferTextSource : ITextSource
        {
