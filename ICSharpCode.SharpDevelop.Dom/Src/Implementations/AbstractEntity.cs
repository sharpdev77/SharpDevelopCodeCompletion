...
namespace ICSharpCode.SharpDevelop.Dom
{
	public abstract class AbstractEntity : AbstractFreezable, IEntity
	{
	    ...
	    public IList<IAttribute> Attributes {
	        get { return attributes ?? (attributes = new List<IAttribute>()); }
	        set {
	            CheckBeforeMutation();
	            attributes = value;
	        }
	    ...
	    private static readonly string ObsoleteAttributeFullName = typeof (ObsoleteAttribute).FullName;

	    private static bool HasObsoleteAttribute(IEnumerable<IAttribute> attributes) {
	        return attributes != null &&
	               attributes.Any(attribute => attribute.AttributeType.FullyQualifiedName == ObsoleteAttributeFullName);
	    }
		...
		protected void CopyDocumentationFrom(IEntity entity) {
		    var ae = entity as AbstractEntity;
		    if (ae == null) {
		        Documentation = entity.Documentation;
		    }
		    else {
		        Documentation = ae.documentation; // do not cause pc.GetXmlDocumentation call for documentation copy
		    }
		}
        ...
        {
            get { return HasObsoleteAttribute(Attributes); }
        }
