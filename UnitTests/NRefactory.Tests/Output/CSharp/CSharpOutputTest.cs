...
namespace ICSharpCode.NRefactory.Tests.PrettyPrinter
{
	...
	public class CSharpOutputTest
	{
		...
		void TestProgram(string program, PrettyPrintOptions options)
		{
            ...
            outputVisitor.Options.PropertyBraceStyle = BraceStyle.NextLine;
			...
			TestProgram(@"unsafe struct CrudeMessage
{
	fixed byte data[4 * sizeof(int)], data2[10];
	    ...
	    [Test]
	    public void ObjectInitializerWithSingleSimpleProperty()
	    {
        ...
        [Test]
	    public void ObjectInitializerWithTwoSimpleProperties()
	    {
	        TestExpression("new Point \n" +
	                       "{\n" +
	                       "  X = 0,\n" +
	    ...
	    [Test]
	    public void ObjectInitializerWithTwoComplexProperties()
	    {
	    ...
	    [Test]
	    public void ObjectInitializerWithTwoComplexPropertiesAndParameterInConstructor()
	    {
  ...
  new Contact 
  {
    ...
    PhoneNumbers = 
    {
      ""650-555-0199""
	    ...
	    {
	        TestExpression("new Dictionary<int, int> \n" +
                           "{\n" + 
	                       "  {\n" +
	                       "    0,\n" +
	                       "    1\n" +
	    ...
	    [Test]
	    public void ComplexSwitchWithBraces()
	    {
            TestStatement("switch (a)\n" +
                          "{\n" +
                          "  case 1:\n" +
        ...
        [Test]
        public void ComplexGetProperty()
        {
            TestTypeMember("public bool ExpectsValue\n" +
                           "{\n" +
                           "  get\n" +
